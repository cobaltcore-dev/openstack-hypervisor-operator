...
// conditions to newCondition. It mirrors the behaviour of
...
//     preserved.
func SetApplyConfigurationStatusCondition(conditions *[]k8sacmetav1.ConditionApplyConfiguration, newCondition k8sacmetav1.ConditionApplyConfiguration) {
	if conditions == nil {
		return
	}
	...
	if existing == nil {
		...
		if newCondition.LastTransitionTime == nil || newCondition.LastTransitionTime.IsZero() {
			now := metav1.Now()
